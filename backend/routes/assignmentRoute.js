...
router.route("/admin/assignments/uploadOrUpdateAllMarks/:assignmentId/").post(isAuthenticatedUser, uploadOrUpdateAllMarks);
...
router.route("/admin/assignments/uploadOrUpdateAllTeamMarks/:assignmentId").post(isAuthenticatedUser, uploadOrUpdateAllTeamMarks);
